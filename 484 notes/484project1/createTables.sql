...
CREATE TABLE Programs(
    ...
    UNIQUE(institution_name, concentration, degree),
...
CREATE TABLE Albums(
    ...
    CHECK(album_visibility = 'Everyone' OR album_visibility = 'Friends' OR album_visibility = 'Friends of Friends' OR album_visibility = 'Myself')
);
